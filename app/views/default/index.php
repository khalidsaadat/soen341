...
?>
<title>SOEN 341 - Mini Amazon</title>
                ...
                <div class="col-lg-7 offset-lg-4">
                    <div class="banner__item">
                        <div class="banner__item__pic">
                            <img src="/assets/products/images/620c6095043fe.jpg" alt="">
                        </div>
                        <div class="banner__item__text">
                            <h2>Summer Collection</h2>
                            <a href="http://localhost/shop/index/filter/category/summer">Shop now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="banner__item banner__item--middle">
                        <div class="banner__item__pic">
                            <img src="/assets/products/images/620c7a93626e6.jpg" alt="">
                        </div>
                        <div class="banner__item__text">
                            <h2>Baby Collection</h2>
                            <a href="http://localhost/shop/index/filter/category/babies">Shop now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="banner__item banner__item--last">
                        <div class="banner__item__pic">
                            <img src="/assets/products/images/620c78e33d226.jpg" alt="">
                        </div>
                        <div class="banner__item__text">
                            <h2>Women Collection</h2>
                            <a href="http://localhost/shop/index/filter/category/woman">Shop now</a>
                        </div>
                    </div>
                </div>
            </div>
